...
class ModelosControllerTest < ActionController::TestCase
  ...
  test "should create modelo" do
    assert_difference('Modelo.count') do
      post :create, modelo: { codigo: @modelo.codigo, fecha_lanzamiento: @modelo.fecha_lanzamiento, nombre: @modelo.nombre, serie_id: @modelo.serie_id, sistema_operativo_id: @modelo.sistema_operativo_id }
    end
  ...
  test "should update modelo" do
    put :update, id: @modelo, modelo: { codigo: @modelo.codigo, fecha_lanzamiento: @modelo.fecha_lanzamiento, nombre: @modelo.nombre, serie_id: @modelo.serie_id, sistema_operativo_id: @modelo.sistema_operativo_id }
    assert_redirected_to modelo_path(assigns(:modelo))
  end
